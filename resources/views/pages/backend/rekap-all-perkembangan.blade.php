            ...
            <div class="modal-body">
                <form action="#" method="post" id="perkembangan_form">
                    ...
                    <div class="row">
                        <div class="col-lg">
                            <div class="my-2">
                                ...
                                <input type="hidden" name="perkembangan_id" id="perkembangan_id" class="form-control" readonly>
                                <input type="hidden" name="kelurahan_id" id="kelurahan_id" value="" class="form-control" readonly>
                                <input type="hidden" name="kecamatan_id" id="kelurahan_id" value="" class="form-control" readonly>
                                <div class="form-control" readonly>
                                    <input type="radio" name="cek" value="pra" id="pra" readonly disabled>
                                </div>
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="my-2">
                                ...
                                <div class="form-control" readonly>
                                    <input type="radio" name="cek" id="mad" value="mad" readonly disabled>
                                </div>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-lg">
                            <div class="my-2">
                                ...
                                <div class="form-control" readonly>
                                    <input type="radio" name="cek" id="pur" value="pur" readonly disabled>
                                </div>
                            ...
                            <div class="my-2">
                                ...
                                <div class="form-control" readonly>
                                    <input type="radio" name="cek" id="man" value="man" readonly disabled>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="my-2">
                        ...
                        <input type="text" name="jml_bgn" id="jml_bgn" value="" class="form-control" readonly>
                        <div class="invalid-feedback"></div>
                    </div>
                    <div class="row">
                        <div class="col-lg">
                            <div class="my-2">
                                ...
                                <input type="text" name="jml_kader" id="jml_kader" value="" class="form-control" readonly>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-lg">
                            <div class="my-2">
                                ...
                                <input type="text" name="jml_terlatih" id="jml_terlatih" value="" class="form-control" readonly>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg">
                            <div class="my-2">
                                ...
                                <input type="text" name="k" id="k" value="" class="form-control" readonly>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg">
                            <div class="my-2">
                                ...
                                <input type="text" name="d" id="d" value="" class="form-control" readonly>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-lg">
                            <div class="my-2">
                                ...
                                <input type="text" name="n" id="n" value="" class="form-control" readonly>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg">
                            <div class="my-2">
                                ...
                                <input type="text" name="vit_a" id="vit_a" value="" class="form-control" readonly>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-lg">
                            <div class="my-2">
                                ...
                                <input type="text" name="kb_aktif" id="kb_aktif" value="" class="form-control" readonly>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg">
                            <div class="my-2">
                                ...
                                <input type="text" name="k4" id="k4" value="" class="form-control" readonly>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-lg">
                            <div class="my-2">
                                ...
                                <input type="text" name="fe3" id="fe3" value="" class="form-control" readonly>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg">
                            <div class="my-2">
                                ...
                                <input type="text" name="campak" id="campak" value="" class="form-control" readonly>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-lg">
                            <div class="my-2">
                                ...
                                <input type="text" name="bcg" id="bcg" value="" class="form-control" readonly>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg">
                            <div class="my-2">
                                ...
                                <input type="text" name="dpt" id="dpt" value="" class="form-control" readonly>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-lg">
                            <div class="my-2">
                                ...
                                <input type="text" name="hbo" id="hbo" value="" class="form-control" readonly>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg">
                            <div class="my-2">
                                ...
                                <input type="text" name="polio" id="polio" value="" class="form-control" readonly>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-lg">
                            <div class="my-2">
                                ...
                                <input type="text" name="gizi" id="gizi" value="" class="form-control" readonly>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
                    <div class="my-2">
                        ...
                        <input type="text" name="diare" id="diare" value="" class="form-control" readonly>
                        <div class="invalid-feedback"></div>
                    </div>
                    <div class="row">
                        <div class="col-lg">
                            <div class="my-2">
                                ...
                                <div class="form-control" readonly>
                                    <input type="checkbox" name="paud" id="paud" value="1" disabled readonly>
                                </div>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-lg">
                            <div class="my-2">
                                ...
                                <div class="form-control" readonly>
                                    <input type="checkbox" name="bkb" id="bkb" value="1" disabled readonly>
                                </div>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg">
                            <div class="my-2">
                                ...
                                <div class="form-control" readonly>
                                    <input type="checkbox" name="bkr" id="bkr" value="1" disabled readonly>
                                </div>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-lg">
                            <div class="my-2">
                                ...
                                <div class="form-control" readonly>
                                    <input type="checkbox" name="bkl" id="bkl" value="1" disabled readonly>
                                </div>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg">
                            <div class="my-2">
                                ...
                                <div class="form-control" readonly>
                                    <input type="checkbox" name="up2k" id="up2k" value="1" disabled readonly>
                                </div>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-lg">
                            <div class="my-2">
                                ...
                                <input type="text" name="as" id="as" value="" class="form-control" readonly>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg">
                            <div class="my-2">
                                ...
                                <div class="form-control" readonly>
                                    <input type="checkbox" name="in" id="in" value="1" disabled readonly>
                                </div>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-lg">
                            <div class="my-2">
                                ...
                                <input type="text" name="ds" id="ds" value="" class="form-control" readonly>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
...
<script>
    $(function() {
        var table = $('.table').DataTable({
            ...
            serverSide: true,
            autoWidth: false,
            ajax: "{{route('all.perkembangan.fetch')}}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                },
        ...
        $(document).on('click', '.editIcon', function(e) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    $('#perkembanganModalTitle').html('Detail Data perkembangan');
        ...
        $(document).on('click', '.deleteIcon', function(e) {
            ...
            let id = $(this).attr('id');
            let csrf = '{{ csrf_token() }}';
            var url = '{{url("all-perkembangan/delete")}}';
            Swal.fire({
                title: 'Are you sure?',
